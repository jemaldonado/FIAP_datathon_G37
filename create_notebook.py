...
with open('notebooks/datathon_main.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=1)

print("OK - Notebook created: notebooks/datathon_main.ipynb")
